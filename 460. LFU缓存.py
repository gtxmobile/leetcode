...
lr=LRU2(3)
lr.set(1,1);print lr.oldest,lr.cache
lr.set(2,2);print lr.oldest,lr.cache
lr.set(3,3);print lr.oldest,lr.cache
lr.set(4,4);print lr.oldest,lr.cache
lr.get(4);print lr.oldest,lr.cache
lr.get(3);print lr.oldest,lr.cache
lr.get(2);print lr.oldest,lr.cache
lr.get(1);print lr.oldest,lr.cache
lr.set(5,5);print lr.oldest,lr.cache
lr.get(1);print lr.oldest,lr.cache
lr.get(2);print lr.oldest,lr.cache
lr.get(3);print lr.oldest,lr.cache
lr.get(4);print lr.oldest,lr.cache
lr.get(5);print lr.oldest,lr.cache
